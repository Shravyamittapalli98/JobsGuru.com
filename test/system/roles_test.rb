...
class RolesTest < ApplicationSystemTestCase
  ...
  test "creating a Role" do
    ...
    fill_in "Company", with: @role.company
    fill_in "Designation", with: @role.designation
    fill_in "Experience", with: @role.experience
    fill_in "Location", with: @role.location
    fill_in "Qualification", with: @role.qualification
    fill_in "Salary", with: @role.salary
